...
void Reactor::OperateReactor(double TBR, double burn_rate){
  ...
  if(bred_fuel_qty >= fuel_usage){/*The way this is written technically allows for a reactor with TBR > 1
#line 109 "/home/dean/Wisconsin/cyclus_fusion/Fusion/src/reactor.cc"
  ...
  //If more fuel is burned than bred, remove the difference from the core, and then replenish the core from storage
    ...
    //Extract Helium:
    ExtractHelium(storage_fuel);
    ExtractHelium(core_fuel);/*This part of the function got hacked together a little bit, and doesn't quite behave like I want it to:
#line 151 "/home/dean/Wisconsin/cyclus_fusion/Fusion/src/reactor.cc"
...
#line 183 "/home/dean/Wisconsin/cyclus_fusion/Fusion/src/reactor.cc"
        if not enough fuel:
          Shutdown
        if Shutdown:
          don't sell
